...
<script>
 ...
 <script>
 function filtrar() {
  var filtro ='http://127.0.0.1:8000/vtasproductos_en_rango_de_fechas/'+$("#fecha_desde").val()+'/'+$("#fecha_hasta").val();
...
<script>
   function excelExport()   {
    window.location.href = 'http://127.0.0.1:8000/productos/export/'+$("#fecha_desde").val()+'/'+$("#fecha_hasta").val();
   }
</script>
@stop
