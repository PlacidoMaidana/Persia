                                             ...
                                             @if ($row->getTranslatedAttribute('display_name')=='proveedor')
                                                ...
                                                <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< --}}
                                                          ...
                                                          <!-- Modal -->
                                                            ...
                                                            <div class="modal fade modal-warning" id="modal_proveedor" v-if="allowCrop">
                                                   ...
                                                   <div class="form-group @if($row->type == 'hidden') hidden @endif col-md-{{ $display_options->width ?? 12 }} {{ $errors->has($row->field) ? 'has-error' : '' }}" @if(isset($display_options->id)){{ "id=$display_options->id" }}@endif>
                                                    ...
                                                    <label class="control-label" for="name">  {{ $row->getTranslatedAttribute('display_name') }}
                                                          ...
                                                          <button type="button" id="proveedor" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal_cliente">
                                                            + proveedor
                                                          </button>
                            ...
                            <div class="col-md-6"><!-- panel-detalles -->
                                ...
                                <div class="col">
                                    ...
                                    @if (isset($renglones))
                                        ...
                                        @livewire('compras.compras', ['renglones' => $renglones])
                                    @else
...
{{--
   ...
   <script>
    $('#proveedor').on('click',function(){
        $('#modal_proveedor').modal({show:true});
