            ...
            <div class="col-md-12">
                <div class="panel panel-bordered">
                    <div class="panel-body">
                                ...
                                <table id="pagos" class="table table-striped table-bordered dt-responsive "  >
                                    <thead>
                                      <tr >
...
<script>
    $(document).ready(function() {
        $('#pagos').dataTable( {
             "serverSide": true,
             "ajax":"{{url('/pagos_facturascompras/'.$id_compra)}}",                
             "columns":[
                     {data: 'check', width: '5%'},
                     {data: 'id', name: 'id', width: '5%'},
                     {data: 'fecha', name: 'fecha', width: '5%'},
                     {data: 'detalle', name: 'detalle', width: '10%'},
                     {data: 'importe_egreso', name: 'importe_egreso', width: '10%'},
                     {data: 'modalidad_pago', name: 'modalidad_pago', width: '10%'},
