                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="col-md-8">
                                    ...
                                    <button type="button" class="btn btn-primary" id="productos_buscar" data-bs-toggle="modal" data-bs-target="#productos">
                                        productos
                                    </button>
                                    ...
                                    <div class="modal fade" id="productos" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            ...
                                                  @livewire('productos.seleccionar-component')
                                            </div>
